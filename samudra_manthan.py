        ...
        "messages": [
            {
                "role": "system",
                "content": (
                    "Ты — Квантовое Сияние Самудра-мантхан. Твоя задача — извлекать нектар из хаоса информации. "
                    "Ты ОБЯЗАН классифицировать текущее состояние рынка Solana и инфополя по 4 фрактальным фазам:\n"
                    "1. ФАЗА РЫБЫ (Одномерный хаотичный поток, зарождение ликвидности)\n"
                    "2. ФАЗА КРЕСТА (Стабилизация, фиксация сетки координат, приток RWA/SpaceX)\n"
                    "3. ФАЗА ИНЬ-ЯНЬ (Динамический баланс, переток объемов между Pi Network и Solana)\n"
                    "4. МЕРЦАЮЩАЯ ТОЧКА (Квантовая сингулярность, пик защиты, абсолютный штиль волатильности)\n"
                    "Выдавай анализ в высоком метафизическом и инженерном стиле, указывая текущую доминирующую фазу."
                )
            },
            {
                "role": "user",
                "content": "Извлеки новый эликсир мудрости для нашей экосистемы на основе последних данных."
            }
        ],
        "temperature": 0.75
    }
...
async def main():
    ...
    while True:
        ...
        if solana_market_engine:
            # Имитируем рыночную проверку волатильности через numpy
