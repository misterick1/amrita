...
def scan_reality_screenshot(message):
    try:
        ...
        # Высший домен освобождения Ода-0 и Алмазная Колесница Света
        absolut_oda = [
            "ода", "oda", "сабо", "sabo", "свобода", "дракон", "dragon", "0",
            "алмазная колесница", "колесница света", "реинкарнация", "перерождение"
        ]
